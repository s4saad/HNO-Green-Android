...
class TransactionDetailsCorScreen extends StatefulWidget {
  ...
  TransactionDetailsCorScreen({this.body, this.type});
...
class _TransactionDetailsScreenState
    extends State<TransactionDetailsCorScreen> {
    ...
    return Scaffold(
      ...
      body: Container(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      trailing: Text(
                        widget.body["data"]["transaction"]["payment_id"].toString() ??
                            "",
                        style: TextStyle(
                            fontSize: 15,
                            color: Colors.black,
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      trailing: Text(
                        widget.body["data"]["transaction"]["state_name"]
                                .toString() ??
                            "",
                        style: TextStyle(
                            fontSize: 15,
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      trailing: Container(
                        ...
                        child: Text(
                          widget.body["data"]["transaction"]["gross"]
                                      .toString() ??
                              "",
                          style: TextStyle(
                              fontSize: 15,
        ...
        title:Text("xcxz"), */
                      ...
                      trailing: Text(
                        widget.body["data"]["transaction"]["net"].toString() ??
                            "",
                        style: TextStyle(
                            fontSize: 15,
                            color: Colors.black,
        ...
        title:Text("xcxz"), */
                      ...
                      trailing: Text(
                        widget.body["data"]["transaction"]["created_at"]
                                .toString() ??
                            "",
                        style: TextStyle(
                            fontSize: 15,
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      trailing: Text(
                        widget.body["data"]["transaction"]["updated_at"]
                                .toString() ??
                            "",
                        style: TextStyle(
                            fontSize: 15,
