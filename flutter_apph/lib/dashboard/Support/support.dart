        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Text(
                  widget.ticket["ticketcategory_id"] == null
                      ? "Other"
                      : widget.ticket["ticketcategory"]["name"],
                ...
                Column(
                  ...
                  children: <Widget>[
                    Text(
                      translator.translate("Created on") + ":",
                      style: TextStyle(fontSize: 10, color: Colors.grey),
                    ),
                    Text(
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (message.value.text.isEmpty) {
                      Flushbar(
                        message: translator.translate("enterMessage"),
                        duration: Duration(seconds: 3),
                      )..show(context);
                    } else {
                      http.post(
                          global.APIEndPoints
                                  .kApiSupportCreateConversationEndPoint +
                              "/${widget.ticket['ticket_id']}",
                          headers: {
              ...
              child: Container(
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    ...
                    http.get(
                      global.APIEndPoints.kApiTicketCloseEndPoint +
                          "${widget.ticket['id']}",
                      headers: {
                        "Authorization": userToken,
