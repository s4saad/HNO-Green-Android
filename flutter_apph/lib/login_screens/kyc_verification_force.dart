...
import 'package:fluttersipay/login_screens/providers/kyc_provider_force.dart';
...
class KYCUserVerificationForceScreen extends StatefulWidget {
  String token;

  KYCUserVerificationForceScreen({this.token});

  @override
  KYCUserVerificationForceScreenState createState() =>
      KYCUserVerificationForceScreenState();
}

class KYCUserVerificationForceScreenState extends State<KYCUserVerificationForceScreen> {
  bool showLoad = true;
          ...
          if (snapshot.hasData) {
            ...
            return new Scaffold(
              ...
              body: ChangeNotifierProvider(
                  create: (context) => KYCForceProvider(
                      LoginRepository(),
                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                        ...
                        child: Consumer<KYCForceProvider>(
