...
public class imagesAdapter extends RecyclerView.Adapter<imagesAdapter.ViewHolder> {
    ...
    private List<ProfileModel.Data.Ppics_All> mData;
    ...
    public imagesAdapter(Context context, List<ProfileModel.Data.Ppics_All> data, Dialog dialog, ImageView imgProfile) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final ProfileModel.Data.Ppics_All animal = mData.get(position);
        try {
            ...
            holder.imgItemList.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ProfileFragment.selectedImageCode=animal.getCode();
                }
            });
